                        ...
                        <View style={{
                            ...
                            <View style={{ backgroundColor: 'white', width: widthh * (250 / 414), height: heightt * (210 / 736), marginTop: heightt * (80 / 736) - heightt * (370 / 736) }}>
                                <View style={{ backgroundColor: '#00000000', width: widthh * (250 / 414), height: heightt * (70 / 736) }}>
                                    <Text style={{ backgroundColor: '#00000000', color: 'black', fontSize: widthh * (18 / 414), fontFamily: 'ProximaNova-Semibold', marginTop: heightt * (10 / 736), marginLeft: widthh * (10 / 414) }}>{src.month}</Text>
                                    <Text style={{ backgroundColor: '#00000000', color: 'black', fontSize: widthh * (25 / 414), fontFamily: 'ProximaNova-Semibold', marginLeft: widthh * (10 / 414) }}>{src.day}</Text>
                                    <Text style={{ backgroundColor: '#00000000', color: 'black', fontSize: widthh * (20 / 414), fontFamily: 'ProximaNova-Semibold', marginTop: widthh * (-55 / 414), marginLeft: widthh * (60 / 414) }}>{src.eventName}</Text>
                                </View>
                                <View style={{ backgroundColor: '#00000000', width: widthh * (250 / 414), height: heightt * (50 / 736) }}>
                                    ...
                                    <Text style={{ backgroundColor: '#00000000', color: 'black', fontSize: widthh * (16 / 414), fontFamily: 'ProximaNova-Semibold', marginTop: heightt * (-15 / 736), marginLeft: widthh * (60 / 414) }}>{src.time}</Text>
                                </View>
                                <View style={{ backgroundColor: '#00000000', width: widthh * (250 / 414), height: heightt * (50 / 736) }}>
                                    ...
                                    <Text style={{ backgroundColor: '#00000000', color: 'black', fontSize: widthh * (16 / 414), fontFamily: 'ProximaNova-Semibold', marginTop: heightt * (-33 / 736), marginLeft: widthh * (60 / 414) }}>{src.address}</Text>
                                </View>
                            </View>
                            <View style={{ backgroundColor: '#50AEED', width: widthh * (250 / 414), height: heightt * (85 / 736), borderBottomLeftRadius: 5, borderBottomRightRadius: 5 }}>
                                <Text style={{ backgroundColor: '#00000000', color: 'white', fontSize: widthh * (20 / 414), fontFamily: 'ProximaNova-Semibold', marginTop: heightt * (10 / 736), marginLeft: widthh * (50 / 414), width: widthh * (150 / 414) }}>{src.name}</Text>
                            </View>
                            <View style={{ backgroundColor: '#00000000', width: widthh * (250 / 414), height: heightt * (120 / 736),marginLeft:width*(25/414), marginTop: widthh * (50 / 414), opacity: qr_view_opacity }}>
                                ...
                                <View style={{ backgroundColor: '#00000000', marginLeft: widthh * (125 / 414), width: widthh * (120 / 414), height: heightt * (120 / 736), marginTop: heightt * (-120 / 736) }}>
                                    <Text style={{ backgroundColor: '#00000000', color: 'black', fontSize: heightt * (16 / 736), fontFamily: 'ProximaNova-Semibold' }}>Ticket Status: </Text>
                                    <Text style={{ backgroundColor: '#00000000', color: 'black', fontSize: heightt * (16 / 736), fontFamily: 'ProximaNova-Semibold' }}>Valid</Text>
                                    <Text style={{ backgroundColor: '#00000000', color: 'black', fontSize: heightt * (16 / 736), fontFamily: 'ProximaNova-Semibold' }}>Ticket CODE: </Text>
                                    <Text style={{ backgroundColor: '#00000000', color: 'black', fontSize: heightt * (16 / 736), fontFamily: 'ProximaNova-Semibold' }}>12D2A</Text>
                                    <Text style={{ backgroundColor: '#00000000', color: 'black', fontSize: heightt * (16 / 736), fontFamily: 'ProximaNova-Semibold' }}>Checked-in: </Text>
                                    <Text style={{ backgroundColor: '#00000000', color: 'black', fontSize: heightt * (16 / 736), fontFamily: 'ProximaNova-Semibold' }}>1/23 9: 25 pm</Text>
                                </View>
                            </View>
                        </View>
